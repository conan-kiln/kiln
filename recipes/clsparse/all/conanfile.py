...
class ClSparseConan(ConanFile):
    name = "clsparse"
    description = "clSPARSE is a software library containing Sparse functions written in OpenCL"
    license = "Apache-2.0"
    homepage = "https://github.com/clMathLibraries/clSPARSE"
    topics = ("opencl", "clmath", "sparse-matrix", "linear-algebra")
    ...
    def requirements(self):
        ...
        self.requires("opencl-clhpp-headers/[*]", transitive_headers=True, transitive_libs=True)
    ...
    def source(self):
        ...
        # Fix an invalid return value. The functions not used anywhere anyway.
        replace_in_file(self, "src/library/io/mm-reader.cpp", "char &GetTypecode( )", "char* GetTypecode( )")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "clSPARSE")
        self.cpp_info.set_property("cmake_target_name", "clSPARSE")
        self.cpp_info.set_property("pkg_config_name", "clSPARSE")
        self.cpp_info.libs = ["clSPARSE"]
