...
class ClBlasConan(ConanFile):
    name = "clblas"
    description = "clBLAS is a software library containing BLAS functions written in OpenCL"
    license = "Apache-2.0"
    homepage = "https://github.com/clMathLibraries/clBLAS"
    topics = ("opencl", "clmath", "blas", "linear-algebra", "gpu-computing")
    ...
    def generate(self):
        ...
        tc.cache_variables["BUILD_RUNTIME"] = True
        tc.cache_variables["BUILD_TEST"] = False
        tc.cache_variables["BUILD_PERFORMANCE"] = False
        tc.cache_variables["BUILD_SAMPLE"] = False
        tc.cache_variables["BUILD_CLIENT"] = False
        tc.cache_variables["BUILD_KTEST"] = False
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "clBLAS")
        self.cpp_info.set_property("cmake_target_name", "clBLAS")
        self.cpp_info.set_property("pkg_config_name", "clBLAS")
        self.cpp_info.libs = ["clBLAS"]
